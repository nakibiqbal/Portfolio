    ...
    <section id="ContactSection">
      <div className="contactMe">
        ...
        <div className="CLinks">
          <div className="mail">
            <a href="mailto:nakibiqbal.2006@gmail.com">
              nakibiqbal.2006@gmail.com
            </a>
          </div>

          <div className="contactIcons">
            <MagnetButton>
              <a href="https://x.com/NakibIqbal" target="_blink">
                <FaXTwitter />
              </a>
            </MagnetButton>
            <MagnetButton>
              <a
                href="https://www.linkedin.com/in/nakib-iqbal/"
                target="_blink"
              >
                <FaLinkedin />
              </a>
      ...
      <div className="islamicQuote">
        <p>
          <b>
            &ldquo;And whoever fears Allah – He will make for him a way out and
            provide for him from where he does not expect.&rdquo;
          </b>
        </p>
