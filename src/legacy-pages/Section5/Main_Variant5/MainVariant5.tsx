...
type MainVariantProps = {
  currentVariant: number;
};

const MainVariant5 = ({ currentVariant }: MainVariantProps) => {
  const variants = [
    <Variants.Variant4
      key={6}
    ...
    <Variants.Variant7
      key={9}
      mainText="Beyond&nbsp;this&nbsp;dimension"
      rangeOFscramble={[35, 35]}
      animReset={2500}
    />,
    <Variants.Variant2
      key={2}
    ...
    <Variants.Variant6
      key={8}
      text1="Escaping&nbsp;reality"
      text2="Escaping&nbsp;reality"
      text3="Escaping&nbsp;reality"
      text4="Escaping&nbsp;reality"
      text5="Escaping&nbsp;reality"
      rangeOFscramble={[35, 50]}
    />,
    ...
    <Variants.Variant7
      key={9}
      mainText="The&nbsp;Paradox"
      rangeOFscramble={[33, 47]}
      animReset={1200}
    />,
    <Variants.Variant2
      key={3}
  ...
  return <>{variants[currentVariant - 1] || null}</>;
};
