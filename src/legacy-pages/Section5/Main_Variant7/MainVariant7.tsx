...
const MainVariant7 = ({ currentVariant }: MainVariantProps) => {
  const variants = [
    ...
    <Variants.Variant6
      ...
      rangeOFscramble={[35, 50]}
    />,
    <Variants.Variant1 key={1} text="Infinity&nbsp;doesn't&nbsp;exist" />,
    ...
    <Variants.Variant7
      key={9}
      mainText="Back&nbsp;without&nbsp;Front"
      rangeOFscramble={[60, 100]}
      animReset={2000}
    />,
  ];
