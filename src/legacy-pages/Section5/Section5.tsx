...
const Section5 = () => {
  const durations1 = [
    3000, 3700, 5500, 4800, 4000, 3200, 2800, 5000, 5000, 4800, 5500, 3000,
    5000, 4000, 5000,
  ];
  const durations2 = [
    5500, 3800, 4000, 3500, 3700, 4500, 3200, 5000, 4500, 4500, 3200, 4000,
    5000, 3000, 4000,
  ];
  const durations3 = [
    3500, 3800, 3800, 3500, 4000, 3000, 3500, 5500, 4500, 3800, 3500, 3500,
    3800, 4000, 4500,
  ];
  const durations4 = [
    4000, 4000, 2500, 5000, 3800, 3000, 3500, 3500, 4500, 3500, 3000, 4000,
    3800, 3500, 3500,
  ];
  const durations5 = [
    3500, 4000, 3500, 3500, 3800, 3000, 3500, 3000, 5000, 3000, 4500, 4000,
    4500, 4500, 4500,
  ];
  const durations6 = [
    3500, 3000, 3800, 3000, 4800, 3000, 3500, 3500, 3700, 3000, 3500, 3000,
    4000, 4000, 5500,
  ];
  const durations7 = [
    3500, 3500, 3800, 4000, 3000, 3500, 4500, 3500, 3500, 3000, 3800, 5000,
    2500, 4000, 4000,
  ];
  const durations8 = [
    3500, 3800, 4000, 3000, 3500, 4500, 3500, 3500, 3000, 3800, 4000, 2500,
    4000, 4000, 3500,
  ];
