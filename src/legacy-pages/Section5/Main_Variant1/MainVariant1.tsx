...
const MainVariant1 = ({ currentVariant }: MainVariantProps) => {
  const variants = [
    ...
    <Variants.Variant7
      key={9}
      mainText="Break&nbsp;the&nbsp;system"
      rangeOFscramble={[35, 40]}
      animReset={1700}
    />,
    ...
    <Variants.Variant7
      key={9}
      mainText="The&nbsp;world&nbsp;is&nbsp;a&nbsp;mirror&nbsp;of&nbsp;lies"
